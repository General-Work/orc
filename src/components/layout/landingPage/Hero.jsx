...
export default function Hero() {
  ...
  let renderables = [{ imageSource: image1 }, { imageSource: image2 }];
  let increaseIndex = () => {
    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex  md:pl-10 item  md:flex-row flex-col  relative overflow-hidden">
        ...
        <div className="absolute bottom-5 left-[48%] flex items-center gap-4">
          {renderables.map((rd, i) => (
            <button
              ...
              className={`${
                currImageIndex == i + 1
                  ? " transform scale-125 transition-transform rounded-full bg-purple-700  grid place-content-center p-2"
        ...
        <div className=" px-5 self-center lg:flex-grow md:w-1/2 md:py-24 lg:pr-24 md:pr-16 flex flex-col  md:items-start md:text-left md:mb-16  items-center text-center">
          ...
          <p className="mb-8 max-w-[50%] md:leading-relaxed text-[#190A3C]/90 text-sm md:text-sm lg:text-inherit">
            Discover our court's commitment to justice, fairness, and the rule
            of law. Access valuable services and resources to support legal
            proceedings and uphold our judicial system.
          </p>
          <div className="px-2  p-5 md:bg-purple-50/20 lg:bg-purple-50 rounded-md hidden md:block  z-20">
            <div className="text-[#190A3C]/90 font-semibold text-lg mb-3 ">
              FILE A CASE
            </div>
        ...
        {/*         <img */}
        {/*           key={i} */}
        {/*           data-aos="animate-scale-bit" */}
        {/*           data-aos-duration="9000" */}
        {/*           data-aos-once="false" */}
        {/*           className="object-cover object-center   md:h-full rounded lg:h-full " */}
        {/*           alt="hero" */}
        {/*           src={rd.imageSource} */}
        {/*         /> */}
        {/*       ), */}
