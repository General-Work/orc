  ...
  return (
    <>
        {!ForgotPassword ? 
                ...
                <>
                    ...
                    <form  onSubmit={Login}>
                        <div className='flex flex-col gap-6'>
                            <FormInputText label="Email" name="email"  autoComplete="off" required/>
                            <FormInputPassword label="Password" name="password"  autoComplete="off" required/>
                        </div>
                        <button 
            ...
            :
            <ForgotPasswordPage setForgotPassword={setForgotPassword} setAlert={setAlert}/>
        }
    </>
  )
}
